...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            accounting::get_liabilities,
            accounting::create_liability,
            accounting::pay_liability,
            accounting::delete_liability,
            accounting::get_liability_ledger,
            ...
            notifications::create_broadcast_notification,
            notifications::get_broadcast_notifications,
            notifications::delete_broadcast_notification,
        ])
